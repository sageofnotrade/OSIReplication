...
class NetworkLayer:
    def __init__(self, ip_address="192.168.1.1", port=7777):  # ✅ Updated to port 7777
    ...
    def send(self, data):
        ...
        self.datalink.send(packet.encode(), mac_address="00:1A:2B:3C:4D:5E")  # ✅ Fixed missing send call

    def receive(self):
        """Receive data from the Data Link Layer and extract the packet contents."""
        frame = self.datalink.receive()  # ✅ No argument needed
