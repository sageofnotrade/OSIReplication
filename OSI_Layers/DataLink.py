...
class DataLinkLayer:
    def __init__(self, mac_address="00:1A:2B:3C:4D:5E", port=7777):  # ✅ Use the same port
    ...
    def send(self, data, mac_address):
        ...
        self.physical.send(frame)  # ✅ Send to the Physical Layer

    def receive(self):
        """Receive a MAC frame, extract data, and return it."""
        received_frame = self.physical.receive()  # ✅ Now correctly calls receive()
